...
class Base():
    ...
    def __init__( 
        ...
        """set controller rotate to be flat"""
    ...
    def _adjustMainCtrlShape( self, ctrl, scale ):
        ...
        mc.move( 70 * scale, ctrl.Off, moveY = True, relative = True )
        
    def _flattenGlobalCtrlShape( self, ctrlObject ):
        
        # flatten ctrl obj shape
...
class Module():
    ...
    def __init__( 
        ...
        self.controlsGrp = mc.group( n = 'Controls_grp', em = 1, p = self.topGrp )
        self.partsGrp = mc.group( n = prefix + 'Parts_grp', em = 1, p = self.topGrp )
        self.jointsGrp = mc.group( n = 'Joints_grp', em = 1, p = self.topGrp )
