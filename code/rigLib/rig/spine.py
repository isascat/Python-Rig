...
def build( 
    ...
    bodyCtrl = control.Control( prefix = prefix + 'Body', translateTo = bodyLocator, scale = rigScale * 7,
                                parent = rigmodule.controlsGrp )
    
    chestCtrl = control.Control( prefix = prefix + 'Chest', translateTo = chestLocator, scale = rigScale * 50,
                                parent = bodyCtrl.C, shape = 'circleZ' )
    
    pelvisCtrl = control.Control( prefix = prefix + 'Pelvis', translateTo = pelvisLocator, scale = rigScale * 40,
                                parent = bodyCtrl.C, shape = 'circleZ' )
    
    middleCtrl = control.Control( prefix = prefix + 'Middle', translateTo = spineCurveClusters[-3], scale = rigScale * 50,
                                parent = bodyCtrl.C, shape = 'circleZ' )
...
def _adjustBodyCtrlShape( bodyCtrl, spineJoints, rigScale ):
    ...
    mc.move( 400, offsetGrp, moveY = 1, relative = 1, objectSpace = 1 )
